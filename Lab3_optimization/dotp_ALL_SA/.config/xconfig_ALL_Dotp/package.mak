...
override PKGDIR = xconfig_ALL_Dotp
...
ti.targets.elf.C66.rootDir ?= C:/ti/ti-cgt-c6000_8.1.2
...
package/%.xdc.inc package/%_xconfig_ALL_Dotp.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_ALL_Dotp" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e66 .dlls: ALL_Dotp.pe66

-include package/cfg/ALL_Dotp_pe66.mak
-include package/cfg/ALL_Dotp_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/ALL_Dotp_pe66.dep
endif
ALL_Dotp.pe66: package/cfg/ALL_Dotp_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
ALL_Dotp.pe66 package/cfg/ALL_Dotp_pe66.c: .libraries,e66
endif

package/cfg/ALL_Dotp_pe66.c package/cfg/ALL_Dotp_pe66.h package/cfg/ALL_Dotp_pe66.xdl: override _PROG_NAME := ALL_Dotp.xe66
package/cfg/ALL_Dotp_pe66.c: package/cfg/ALL_Dotp_pe66.cfg
package/cfg/ALL_Dotp_pe66.xdc.inc: package/cfg/ALL_Dotp_pe66.xdl
package/cfg/ALL_Dotp_pe66.xdl package/cfg/ALL_Dotp_pe66.c: .interfaces

clean:: clean,e66
	-$(RM) package/cfg/ALL_Dotp_pe66.cfg
	-$(RM) package/cfg/ALL_Dotp_pe66.dep
	-$(RM) package/cfg/ALL_Dotp_pe66.c
	-$(RM) package/cfg/ALL_Dotp_pe66.xdc.inc

clean,e66::
	-$(RM) ALL_Dotp.pe66
.executables,e66 .executables: ALL_Dotp.xe66

ALL_Dotp.xe66: |ALL_Dotp.pe66

-include package/cfg/ALL_Dotp.xe66.mak
ALL_Dotp.xe66: package/cfg/ALL_Dotp_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/ALL_Dotp_pe66.oe66   package/cfg/ALL_Dotp_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/libc.a
	
ALL_Dotp.xe66: export C_DIR=
ALL_Dotp.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)
ALL_Dotp.xe66: Path:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)

ALL_Dotp.test test,e66 test: ALL_Dotp.xe66.test

ALL_Dotp.xe66.test:: ALL_Dotp.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 ALL_Dotp.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.ALL_Dotp.xe66, ) 
endif

clean,e66::
	-$(RM) $(wildcard .tmp,ALL_Dotp.xe66,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
ALL_Dotp_pe66.oe66,copy : package/cfg/ALL_Dotp_pe66.oe66
ALL_Dotp_pe66.se66,copy : package/cfg/ALL_Dotp_pe66.se66

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_ALL_Dotp
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_ALL_Dotp.tar.dep
endif
package/rel/xconfig_ALL_Dotp/xconfig_ALL_Dotp/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_ALL_Dotp/xconfig_ALL_Dotp/package/package.rel.xml: package/build.cfg
package/rel/xconfig_ALL_Dotp/xconfig_ALL_Dotp/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_ALL_Dotp/xconfig_ALL_Dotp/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_ALL_Dotp.tar: package/rel/xconfig_ALL_Dotp.xdc.inc package/rel/xconfig_ALL_Dotp/xconfig_ALL_Dotp/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_ALL_Dotp.xdc.inc,package/rel/xconfig_ALL_Dotp.tar.dep)


release release,xconfig_ALL_Dotp: all xconfig_ALL_Dotp.tar
clean:: .clean
	-$(RM) xconfig_ALL_Dotp.tar
	-$(RM) package/rel/xconfig_ALL_Dotp.xdc.inc
	-$(RM) package/rel/xconfig_ALL_Dotp.tar.dep
