...
linker.cmd: package/cfg/helloWorld_pe66.xdl
	$(SED) 's"^\"\(package/cfg/helloWorld_pe66cfg.cmd\)\"$""\"L:/C66/All_code/Chapter16_Debugging/Systen_Analyzer_Example/.config/xconfig_helloWorld/\1\""' package/cfg/helloWorld_pe66.xdl > $@
