...
override PKGDIR = xconfig_ConfigurationForAll
...
ti.targets.elf.C66.rootDir ?= C:/CCS6/ccsv6/tools/compiler/c6000_7.4.14
...
package/%.xdc.inc package/%_xconfig_ConfigurationForAll.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_ConfigurationForAll" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e66 .dlls: ConfigurationForAll.pe66

-include package/cfg/ConfigurationForAll_pe66.mak
-include package/cfg/ConfigurationForAll_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/ConfigurationForAll_pe66.dep
endif
ConfigurationForAll.pe66: package/cfg/ConfigurationForAll_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
ConfigurationForAll.pe66 package/cfg/ConfigurationForAll_pe66.c: .libraries,e66
endif

package/cfg/ConfigurationForAll_pe66.c package/cfg/ConfigurationForAll_pe66.h package/cfg/ConfigurationForAll_pe66.xdl: override _PROG_NAME := ConfigurationForAll.xe66
package/cfg/ConfigurationForAll_pe66.c: package/cfg/ConfigurationForAll_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/ConfigurationForAll_pe66.cfg
	-$(RM) package/cfg/ConfigurationForAll_pe66.dep
	-$(RM) package/cfg/ConfigurationForAll_pe66.c
	-$(RM) package/cfg/ConfigurationForAll_pe66.xdc.inc

clean,e66::
	-$(RM) ConfigurationForAll.pe66
.executables,e66 .executables: ConfigurationForAll.xe66

ConfigurationForAll.xe66: |ConfigurationForAll.pe66

-include package/cfg/ConfigurationForAll.xe66.mak
ConfigurationForAll.xe66: package/cfg/ConfigurationForAll_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/ConfigurationForAll_pe66.oe66   package/cfg/ConfigurationForAll_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/libc.a
	
ConfigurationForAll.xe66: export C_DIR=
ConfigurationForAll.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)
ConfigurationForAll.xe66: Path:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)

ConfigurationForAll.test test,e66 test: ConfigurationForAll.xe66.test

ConfigurationForAll.xe66.test:: ConfigurationForAll.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 ConfigurationForAll.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.ConfigurationForAll.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,ConfigurationForAll.xe66,0,*


clean:: clean,e66

clean,e66::
	-$(RM) ConfigurationForAll.xe66
clean:: 
	-$(RM) package/cfg/ConfigurationForAll_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
ConfigurationForAll_pe66.oe66,copy : package/cfg/ConfigurationForAll_pe66.oe66
ConfigurationForAll_pe66.se66,copy : package/cfg/ConfigurationForAll_pe66.se66

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_ConfigurationForAll
xconfig_ConfigurationForAll.tar: package/package.bld.xml
xconfig_ConfigurationForAll.tar: package/build.cfg
xconfig_ConfigurationForAll.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_ConfigurationForAll.tar.dep
endif
package/rel/xconfig_ConfigurationForAll/xconfig_ConfigurationForAll/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_ConfigurationForAll.tar: package/rel/xconfig_ConfigurationForAll.xdc.inc package/rel/xconfig_ConfigurationForAll/xconfig_ConfigurationForAll/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_ConfigurationForAll.xdc.inc,package/rel/xconfig_ConfigurationForAll.tar.dep)


release release,xconfig_ConfigurationForAll: all xconfig_ConfigurationForAll.tar
clean:: .clean
	-$(RM) xconfig_ConfigurationForAll.tar
	-$(RM) package/rel/xconfig_ConfigurationForAll.xdc.inc
	-$(RM) package/rel/xconfig_ConfigurationForAll.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_ConfigurationForAll.pjt
